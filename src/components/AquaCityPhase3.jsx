...
export default function AquaCityPhase3() {
  ...
  useEffect(() => {
    ...
    tl.to(cardRef.current,
      { opacity: 0, x: 60, rotation: 1.5, ease: 'none', duration: 0.09 }, 0.91)
    tl.to({}, { duration: 0 }, 1)
  ...
  return (
    <div data-section="aquacity-phase3">
      <CanvasSection name="aquacity-phase3" totalFrames={174} height="320vh" zIndex={12} focusX={0.15}>
        ...
        <div ref={cardRef} className="slide-card" style={{ position: 'absolute', bottom: '10%', right: '8%', width: 'min(84%, 500px)', textAlign: 'right', opacity: 0 }}>
