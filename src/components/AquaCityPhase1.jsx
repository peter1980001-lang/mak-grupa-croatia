// src/components/AquaCityPhase1.jsx — slides 18–19  (z-index 6)
...
export default function AquaCityPhase1() {
  ...
  return (
    <div data-section="aquacity-phase1">
      <CanvasSection name="aquacity-phase1" totalFrames={170} height="320vh" zIndex={6}>
        <div style={{
        ...
        <div ref={phaseRef} style={{
          position: 'absolute', top: '8%', left: '8%', opacity: 0,
        }}>
          <span style={{
        ...
        <div style={{ position: 'absolute', top: '50%', left: '8%', transform: 'translateY(-50%)', maxWidth: '500px' }}>
          ...
          <h2 ref={headlineRef} style={{
            opacity: 0, color: '#ffffff', fontSize: 'clamp(1.8rem, 3.5vw, 3rem)',
