// src/components/AquaCityPhase5.jsx — lake accommodation & glamping  (z-index 12)
...
export default function AquaCityPhase5() {
  ...
  useEffect(() => {
    ...
    tl.fromTo(labelRef.current,
      { opacity: 0, y: 8 }, { opacity: 1, y: 0, ease: 'none', duration: 0.10 }, 0.10)
    tl.fromTo(headlineRef.current,
      { opacity: 0, y: 14 }, { opacity: 1, y: 0, ease: 'none', duration: 0.12 }, 0.15)
  ...
  return (
    <div data-section="aquacity-phase5">
      <CanvasSection name="aquacity-phase5" totalFrames={187} height="320vh" zIndex={14}>
        <div style={{
        ...
        <div style={{ position: 'absolute', bottom: '12%', left: '50%', transform: 'translateX(-50%)', maxWidth: '600px', textAlign: 'center' }}>
          <GlassBox style={{ borderRadius: '16px', padding: '2.2rem 3rem' }}>
            <p ref={labelRef} style={{
              opacity: 0, color: '#c9a84c', fontSize: 'clamp(0.65rem, 1vw, 0.8rem)',
              fontFamily: 'system-ui, sans-serif', fontWeight: 400,
              letterSpacing: '0.3em', textTransform: 'uppercase', marginBottom: '1.2rem',
            }}>Smještaj na jezeru</p>
            <h2 ref={headlineRef} style={{
              opacity: 0, color: '#ffffff', fontSize: 'clamp(2rem, 3.8vw, 3.2rem)',
            ...
            <ul ref={bodyRef} style={{ opacity: 0, listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
