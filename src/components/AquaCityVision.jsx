// src/components/AquaCityVision.jsx — slides 9–10  (z-index 5)
...
export default function AquaCityVision() {
  ...
  useEffect(() => {
    ...
    tl.fromTo(headlineRef.current,
      { opacity: 0, y: 16 }, { opacity: 1, y: 0, ease: 'none', duration: 0.14 }, 0.13)
  ...
  return (
    <div data-section="aquacity-vision">
      <CanvasSection name="aquacity-vision2" totalFrames={186} height="320vh" zIndex={5}>
        <div style={{
        ...
        <div style={{
          ...
          <div ref={pillarsRef} style={{ opacity: 0, display: 'flex', justifyContent: 'center', gap: '3rem' }}>
            {[{ n: '01', label: 'Aktivno jezero' }, { n: '02', label: 'Cijeli dan' }, { n: '03', label: 'Cijelu godinu' }].map((p) => (
              <div key={p.n} style={{ textAlign: 'center' }}>
                ...
                <p style={{
                  color: 'rgba(255,255,255,0.6)', fontSize: 'clamp(0.7rem, 1vw, 0.85rem)',
                  fontFamily: 'system-ui, sans-serif', fontWeight: 300,
